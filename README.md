...
- **2025-06**: The challenge ended successfully 🎉🎉🎉, attracting participation from more than 30 scientific research teams. Among them, the **V3A team from Adelaide University** won the championship in the CVPR2025 SMM Challenge🏆.
...
![20241202_221141](https://gitee.com/pzhren/img/raw/master/img/202412022211858.png)
...
- Format conversion: _PKL/PLY &rarr; OBJ &rarr; USD_. For example, [Objaverse](https://huggingface.co/datasets/allenai/objaverse).
- Format conversion: _GLB &rarr; USD_. For example, [MH3D](https://github.com/matterport/habitat-matterport-3dresearch).
